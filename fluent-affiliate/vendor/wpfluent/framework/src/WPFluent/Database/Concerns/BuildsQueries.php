...
use FluentAffiliate\Framework\Container\Container;
...
use FluentAffiliate\Framework\Support\Conditionable;
...
use FluentAffiliate\Framework\Database\MultipleRecordsFoundException;
use FluentAffiliate\Framework\Pagination\Cursor;
use FluentAffiliate\Framework\Pagination\Paginator;
use FluentAffiliate\Framework\Pagination\CursorPaginator;
use FluentAffiliate\Framework\Pagination\LengthAwarePaginator;

/**
 * @template TValue
 *
 * @mixin \FluentAffiliate\Framework\Database\Orm\Builder
...
trait BuildsQueries
{
     ...
     *
     * @param  int  $count
     * @param  callable(\FluentAffiliate\Framework\Support\Collection<int, TValue>, int): mixed  $callback
     * @return bool
     */
     ...
     * @param  int  $count
     * @return \FluentAffiliate\Framework\Support\Collection<int, TReturn>
     */
     ...
     *
     * @param  \FluentAffiliate\Framework\Database\Query\Builder|\FluentAffiliate\Framework\Database\Orm\Builder<*>  $builder
     ...
     * @param  \FluentAffiliate\Framework\Support\Collection  $items
     * @param  int  $perPage
     * @param  \FluentAffiliate\Framework\Pagination\Cursor  $cursor
     * @param  array  $options
     * @return \FluentAffiliate\Framework\Pagination\CursorPaginator
     */
