...
namespace FluentAffiliate\Framework\Foundation\Concerns;

use FluentAffiliate\Framework\Support\Facade;
...
trait DynamicFacadeTrait
{
     ...
     *
     * @param  string $facade Facade namespace prefix (e.g., FluentAffiliate\Framework\Facade)
