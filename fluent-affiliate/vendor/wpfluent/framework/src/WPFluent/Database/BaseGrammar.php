...
abstract class BaseGrammar
{
     ...
     *
     * @param  \FluentAffiliate\Framework\Database\Query\Expression|string  $value
     * @return string
     */
     ...
     *
     * @param  \FluentAffiliate\Framework\Database\Query\Expression|string  $table
     * @return string
     */
     ...
     *
     * @param  \FluentAffiliate\Framework\Database\Query\Expression|string|int|float  $expression
