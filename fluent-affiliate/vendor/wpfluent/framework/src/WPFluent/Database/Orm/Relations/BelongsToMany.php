...
use FluentAffiliate\Framework\Database\Orm\ModelNotFoundException;
...
use FluentAffiliate\Framework\Database\Orm\Relations\Concerns\InteractsWithDictionary;
use FluentAffiliate\Framework\Database\Orm\Relations\Concerns\InteractsWithPivotTable;
...
class BelongsToMany extends Relation
{
     ...
     *
     * @var array<string|\FluentAffiliate\Framework\Database\Query\Expression>
     */
     ...
     *
     *
     * @param  \FluentAffiliate\Framework\Database\Orm\Builder<TRelatedModel>  $query
     ...
     *
     * @param  \FluentAffiliate\Framework\Database\Orm\Builder<TRelatedModel>|null  $query
     * @return $this
     */
     ...
     *
     * @param  \FluentAffiliate\Framework\Database\Orm\Collection<int, TRelatedModel>  $results
     ...
     *
     * @param  string|\FluentAffiliate\Framework\Database\Query\Expression|array<string, string>  $column
     * @param  mixed  $value
     * @return $this
     *
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentAffiliate\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentAffiliate\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel|null
     */
     ...
     * @param  array  $columns
     * @return \FluentAffiliate\Framework\Database\Orm\Collection<int, TRelatedModel>
     */
     ...
     * @return \FluentAffiliate\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel
     *
     * @throws \FluentAffiliate\Framework\Database\Orm\ModelNotFoundException<TRelatedModel>
     */
     ...
     * @return \FluentAffiliate\Framework\Database\Orm\Collection<int, TRelatedModel>|TRelatedModel|TValue
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \FluentAffiliate\Framework\Pagination\Paginator
     */
     ...
     *
     * @param  int  $chunkSize
     * @return \FluentAffiliate\Framework\Support\LazyCollection<int, TRelatedModel>
     */
     ...
     *
     * @return \FluentAffiliate\Framework\Database\Orm\Builder<TRelatedModel>
     */
     ...
     *
     * @return \FluentAffiliate\Framework\Support\Collection<int, int|string>
     */
     ...
     *
     * @template TContainer of \FluentAffiliate\Framework\Support\Collection<array-key, TRelatedModel>|array<array-key, TRelatedModel>
     *
     ...
     *
     * @param  \FluentAffiliate\Framework\Database\Orm\Builder<TRelatedModel>  $query
     * @param  \FluentAffiliate\Framework\Database\Orm\Builder<TDeclaringModel>  $parentQuery
     ...
     *
     * @param  string|\FluentAffiliate\Framework\Database\Query\Expression  $column
     * @return string|\FluentAffiliate\Framework\Database\Query\Expression
     */
