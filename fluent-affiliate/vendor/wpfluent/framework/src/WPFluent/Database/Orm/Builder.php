...
use FluentAffiliate\Framework\Support\HelperFunctionsTrait;
use FluentAffiliate\Framework\Database\Query\Expression;
use FluentAffiliate\Framework\Database\Concerns\BuildsQueries;
use FluentAffiliate\Framework\Database\RecordsNotFoundException;
use FluentAffiliate\Framework\Database\Orm\Relations\Relation;
use FluentAffiliate\Framework\Database\Orm\Relations\BelongsToMany;
use FluentAffiliate\Framework\Database\Orm\RelationNotFoundException;
use FluentAffiliate\Framework\Database\Orm\Concerns\QueriesRelationships;
use FluentAffiliate\Framework\Database\UniqueConstraintViolationException;
use FluentAffiliate\Framework\Database\Query\Builder as QueryBuilder;

/**
 * @property-read HigherOrderBuilderProxy $orWhere
 *
 * @mixin \FluentAffiliate\Framework\Database\Query\Builder
 *
 * @template TModel of \FluentAffiliate\Framework\Database\Orm\Model
 */
class Builder
{
     ...
     *
     * @var \FluentAffiliate\Framework\Database\Query\Builder
     */
    protected $query;
     ...
     *
     * @var \FluentAffiliate\Framework\Database\Orm\Model
     */
    protected $model;
     ...
     * @return \FluentAffiliate\Framework\Database\Orm\Model|static
     */
     ...
     * @param  \FluentAffiliate\Framework\Database\Orm\Scope|\Closure  $scope
     * @return $this
     */
     ...
     *
     * @param  \FluentAffiliate\Framework\Database\Orm\Scope|string  $scope
     * @return $this
     */
     ...
     * @param  mixed  $value
     * @param  string  $boolean
     * @return \FluentAffiliate\Framework\Database\Orm\Model|static|null
     */
     ...
     *
     * @param  \Closure|array|string|\FluentAffiliate\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  (\Closure(static): mixed)|string|array|\FluentAffiliate\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @param  string  $boolean
     * @return $this
     ...
     *
     * @param  (\Closure(static): mixed)|array|string|\FluentAffiliate\Framework\Database\Query\Expression  $column
     * @param  mixed  $operator
     * @param  mixed  $value
     * @return $this
     */
     ...
     *
     * @param  array  $items
     * @return \FluentAffiliate\Framework\Database\Orm\Collection
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentAffiliate\Framework\Database\Orm\Model|\FluentAffiliate\Framework\Database\Orm\Collection|static[]|static|null
     */
     ...
     *
     * @param  \FluentAffiliate\Framework\Support\ArrayableInterface|array  $ids
     * @param  array  $columns
     * @return \FluentAffiliate\Framework\Database\Orm\Collection
     */
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentAffiliate\Framework\Database\Orm\Model|\FluentAffiliate\Framework\Database\Orm\Collection|static|static[]
     *
     * @throws \FluentAffiliate\Framework\Database\Orm\ModelNotFoundException
     */
     ...
     * @return TModel|TValue|\FluentAffiliate\Framework\Database\Orm\Collection
     */
     ...
     * @return \FluentAffiliate\Framework\Database\Orm\Model|static|mixed
     */
     ...
     * @return \FluentAffiliate\Framework\Database\Orm\Model
     *
     * @throws \FluentAffiliate\Framework\Database\Orm\ModelNotFoundException
     ...
     * @return mixed
     *
     * @throws \FluentAffiliate\Framework\Database\Orm\ModelNotFoundException<TModel>
     * @throws \FluentAffiliate\Framework\Database\MultipleRecordsFoundException
     */
     ...
     *
     * @param  array|string  $columns
     * @return \FluentAffiliate\Framework\Database\Orm\Collection|static[]
     */
     ...
     *
     * @param  string  $name
     * @return \FluentAffiliate\Framework\Database\Orm\Relations\Relation
     */
     ...
     * @return \FluentAffiliate\Framework\Pagination\LengthAwarePaginator
     *
     ...
     * @return \FluentAffiliate\Framework\Pagination\CursorPaginator
     */
     ...
     *
     * @param  array  $attributes
     * @return \FluentAffiliate\Framework\Database\Orm\Model|$this
     */
     ...
     *
     * @param  array|\FluentAffiliate\Framework\Database\Query\Expression  $columns
     * @return array
     */
