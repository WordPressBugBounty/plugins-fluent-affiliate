...
abstract class HasOneOrManyThrough extends Relation
{
     ...
     * @param  mixed  $id
     * @param  array  $columns
     * @return \FluentAffiliate\Framework\Database\Orm\Model| \FluentAffiliate\Framework\Database\Orm\Collection<int, TRelatedModel>
     *
     ...
     * @param  (\Closure(): TValue)|null  $callback
     * @return \FluentAffiliate\Framework\Database\Orm\Model|\FluentAffiliate\Framework\Database\Orm\Collection<int, TRelatedModel>|TValue
     */
